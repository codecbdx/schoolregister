    ...
    @foreach ($alumnos->values() as $index => $alumno)
        <div
            ...
            <div style="display: block; float: left; width: 37%; text-align: center;">
                <img src="{{ $alumno && $alumno->user_image ? $alumno->user_image : asset('assets/images/user.png') }}"
            ...
            <div style="display: block; float: right; width: 63%;">
                <p style="font-size: 0.9em; margin-top: 20px; margin-right: 8px;"><b>{{ __('Name') }}
                        :</b> {{ $alumno->nombre }} {{ $alumno->apellido_paterno }} {{ $alumno->apellido_materno }}
                </p>
                <p style="font-size: 0.9em; margin-right: 8px;"><b>{{ __('CURP') }}:</b> {{ $alumno->curp }}</p>
                <p style="font-size: 0.9em; margin-right: 8px;"><b>{{ __('Email Address') }}:</b>
                    {{ $alumno->correo }}</p>
                <p style="font-size: 0.9em; margin-right: 8px;"><b>{{ __('Tutor') }}
                        :</b> {{ $alumno->nombre_tutor }} {{ $alumno->apellido_paterno_tutor }}
