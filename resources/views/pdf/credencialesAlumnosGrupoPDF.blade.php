...
@foreach($alumnos as $alumno)
    <div style="width: 400px; height: 260px; margin: 0 auto; margin-bottom: 20px; border: 1px solid #000!important;">
        <div
        ...
        <div style="display: block; float: left; width: 37%; text-align: center;">
            <img
                src="{{ $alumno && $alumno->user_image ? (env('AWS_URL') . $alumno->user_image) : asset('assets/images/user.png') }}"
