                                ...
                                <tr>
                                    <th>
                                        <a wire:click.prevent="sortBy('nombre')" role="button"
                                           href="#">
                                            <i class="mdi mdi-sort ml-0"></i> {{ __('High School')  }}
                                        </a>
                                    </th>
                                    <th>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="name" class="control-label">{{ ucfirst(strtolower(__('High School'))) }}</label>
                                            <input id="name" type="text"
                                                   class="form-control @error('nombre_create') is-invalid @enderror"
                                                   wire:model="nombre_create"
                                                   placeholder="{{ ucfirst(strtolower(__('High School'))) }}"
