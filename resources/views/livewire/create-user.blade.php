...
<div>
    <form wire:submit="save">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input id="paternalLastName" type="text"
                                       ...
                                       wire:model="paternal_lastname" placeholder="{{ __('PaternalLastName') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input id="maternalLastName" type="text"
                                       ...
                                       wire:model="maternal_lastname" placeholder="{{ __('MaternalLastName') }}"
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card bg-transparent shadow-none border-0">
                    <h4 class="card-subtitle text-dark">{{ __('Create Password') }}</h4>
                    <p class="card-description text-black">
                        {{ __('Make sure your account is using a long, random password to stay secure.') }}</p>
                </div>
            </div>
            <div class="col-lg-8 grid-margin stretch-card">
                <div class="card">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card bg-transparent shadow-none border-0">
                    ...
                    <p class="card-description text-black">
                        {{ __('For your user, consider adding a photo that is clear and centered on their face for easy identification.') }}
                    </p>
                </div>
            </div>
            <div class="col-lg-8 grid-margin stretch-card">
                        ...
                        <div class="form-group m-0">
                            ...
                            @if ($image && !$errors->has('image'))
                                <div class="d-flex justify-content-center align-items-center">
                                    <img height="180px" class="mt-3" src="{{ $image->temporaryUrl() }}"/>
                                </div>
                            @endif
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card bg-transparent shadow-none border-0">
                    ...
                    <p class="card-description text-black">
                        {{ __('Here you can adjust essential details such as your role type and school.') }}</p>
                </div>
            </div>
            <div class="col-lg-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="select-user-role" class="col-form-label">{{ __('Rol Type') }}</label>
                            <select class="form-control @error('user_type') is-invalid @enderror"
                                    id="select-user-role" wire:model="user_type">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('user_type') is-invalid @enderror"
                                ...
                                <option selected>{{ __('Select your school') }}</option>
