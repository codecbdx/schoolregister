                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    @foreach ($list_concepto_pago_alumno as $concepto_pago_alumno)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('history_payment_student', ['id' => config('app.debug') ? $concepto_pago_alumno->folio : encrypt($concepto_pago_alumno->folio)]) }}"
                                                   class="btn btn-inverse-success btn-icon-text mb-1 mb-md-0"
                                                   data-toggle="tooltip"
                                                   data-placement="top" title="{{ __('Payment') }}">
