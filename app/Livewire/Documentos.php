...
class Documentos extends Component
{
    ...
    public $ine_pdf, $ine_tutor_pdf, $curp_pdf, $curp_tutor_pdf, $address_pdf, $current_ine_pdf, $current_ine_tutor_pdf, $current_curp_pdf, $current_curp_tutor_pdf, $current_address_pdf, $curp, $mayor_edad;
